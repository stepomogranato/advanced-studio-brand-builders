      ...
      <section className="px-6 md:px-10 max-w-[1600px] mx-auto pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
          {brands.map((b, i) => (
            ...
            >
              <img src={b.image} alt={b.name} loading="lazy" className="absolute inset-0 h-full w-full object-cover transition-transform duration-[1200ms] group-hover:scale-105" />
